...
//     if ( !ENV.fromWeb ) {
//         $cordovaSQLite.execute( db, 'SELECT * FROM sql_Csbk1 ORDER BY TrxNo DESC' )
//             .then(
//                 function( res ) {
//                 alert(res);
//                     if ( res.rows.length > 0 && is.not.undefined( res.rows.item( 0 ).TrxNo ) ) {
//                         console.log('Found LoginInfo');
//                         var value = res.rows.item( 0 ).TrxNo;
